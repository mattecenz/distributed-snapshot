...
/**
 * Abstaact class which works as template for all the library messages.
 */
...
Message implements Serializable {
    ...
    /**
     * Constructor used only by the ack, as the sequence number must match the one from the message received.
